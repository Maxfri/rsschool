...
import './garage.scss';
import { getCars } from '../../../api/garage/garage';
...
export class Garage extends BaseComponent {
  ...
  constructor() {
    ...
    console.log(btnCreate.element);
    this.element.appendChild(btnCreate.element);
    // this.getCar(1);
    // this.createCar('Ziguli', '#f5e7c6');
    // this.deleteCar(5);
    // this.updateCar(3, 'string2', 'string2');
  }
  ...
  listen(formElem: HTMLFormElement) {
    formElem.onsubmit = async (e) => {
      ...
      const response = await fetch('http://127.0.0.1:3000/garage', {
        ...
        body: JSON.stringify(new FormData(formElem)),
      });
