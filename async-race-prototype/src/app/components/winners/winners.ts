...
export class Winners extends BaseComponent {
  ...
  static renderWinner(winner: Winner) {
    return `<td>${winner.id}</td>
            ...
            style="enable-background:new 0 0 122.88 35.03" xml:space="preserve"><style type="text/css">
            .car-image{fill-rule:evenodd;clip-rule:evenodd;}
            </style><g>
            <path class="car-image" fill="" d="M99.42,13.57c5.93,0,10.73,4.8,10.73,10.73c0,5.93-4.8,10.73-10.73,10.73s-10.73-4.8-10.73-10.73 
