    ...
    this.element.innerHTML = `<h1 class="winners-title">Winners</h1>
      ...
      <table>
        <thead>
          ...
          <th class="sort-name sort" data-order="ASC">Name of the car</th>
          <th class="sort-wins sort" data-order="ASC">Wins number</th>
          <th class="sort-time sort" data-order="ASC">Best time in seconds</th>
        </thead>
